// To parse this data:
//
//   import { Convert, GifsSearchResposnse } from "./file";
//
//   const gifsSearchResposnse = Convert.toGifsSearchResposnse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface GifsSearchResposnse {
    data:       Gif[];
...
export class Convert {
    public static toGifsSearchResposnse(json: string): GifsSearchResposnse {
        return cast(JSON.parse(json), r("GifsSearchResposnse"));
    }

    public static gifsSearchResposnseToJson(value: GifsSearchResposnse): string {
        return JSON.stringify(uncast(value, r("GifsSearchResposnse")), null, 2);
    }
}
